	...
	public void actionPerformed(ActionEvent ae)
	{
		if(ae.getSource() == btnUp)
		{
			if((currentPos-4) >= 0)
			{
				...
				JOptionPane.showMessageDialog(btnUp,"Up limit exceeded","Error",JOptionPane.ERROR_MESSAGE);
		}
		else if(ae.getSource() == btnDown)
		{
			if((currentPos+4) < 16)
			{
				...
				JOptionPane.showMessageDialog(btnDown,"Down limit exceeded","Error",JOptionPane.ERROR_MESSAGE);
		}
		else if(ae.getSource() == btnRight)
		{
			if((currentPos+1) < 16)
			{
				...
				if((currentPos) == 4 || (currentPos) == 8 || (currentPos) == 12)
				{
					currentPos-=1;
					changePos();
					JOptionPane.showMessageDialog(btnRight,"Right limit exceeded","Error",JOptionPane.ERROR_MESSAGE);
				}
				else
					changePos();
		...
		else
		{
			if((currentPos-1) >= 0)
			{
				...
				if((currentPos) == 3 || (currentPos) == 7 || (currentPos) == 11)
				{
					currentPos+=1;
					changePos();
					JOptionPane.showMessageDialog(btnLeft,"Left limit exceeded","Error",JOptionPane.ERROR_MESSAGE);
				}
				else
					changePos();
